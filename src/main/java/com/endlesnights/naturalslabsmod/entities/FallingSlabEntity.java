package com.endlesnights.naturalslabsmod.entities;
...
public class FallingSlabEntity extends Entity
{
	   ...
	   public FallingSlabEntity(EntityType<? extends FallingBlockEntity> p_i50218_1_, World p_i50218_2_) {
	      super(p_i50218_1_, p_i50218_2_);
	   }

	   public FallingSlabEntity(World worldIn, double x, double y, double z, BlockState fallingBlockState) {
	            ...
	            if (!this.onGround && !flag1) {
	               ...
	               if (blockstate.getBlock() != Blocks.MOVING_PISTON) {
	                  ...
	                  if (!this.dontSetBlock) {
	                     ...
	                     boolean flag3 = this.fallTile.isValidPosition(this.world, blockpos1) && !FallinglSlab.canFallThrough(this.world.getBlockState(blockpos1.down()));
	                     if (flag2 && flag3) {
	                        ...
	                        if (this.world.setBlockState(blockpos1, this.fallTile, 3)) {
	                              ((FallinglSlab)block).onEndFalling(this.world, blockpos1, this.fallTile, blockstate);
	                     ...
	                     {
	                    	((FallinglSlab)block).breakFall(this.world, blockpos1, this.fallTile, blockstate, this);
	                     }
	                  } else{
	                     ((FallinglSlab)block).onBroken(this.world, blockpos1);
	                  }
	               }
	            }
	         }
